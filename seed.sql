INSERT INTO album (album_name, band_name, link) VALUES
('Dark Side of the Moon', 'Pink Floyd', 'https://en.wikipedia.org/wiki/The_Dark_Side_of_the_Moon'),
('Appetite for Destruction', 'Guns N Roses', 'https://en.wikipedia.org/wiki/Appetite_for_Destruction'),
('Back in Black', 'AC/DC', 'https://en.wikipedia.org/wiki/Back_in_Black'),
('Master of Puppets', 'Metallica', 'https://en.wikipedia.org/wiki/Master_of_Puppets'),
('IV', 'Led Zeppelin', 'https://en.wikipedia.org/wiki/Led_Zeppelin_IV'),
